...
/**
 * This is the item provider adapter for a {@link Healthcare.Hospital} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class HospitalItemProvider extends NamedElementItemProvider {
	/**
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Hospital_staff_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Hospital_staff_feature", "_UI_Hospital_type"),
				 HealthcarePackage.Literals.HOSPITAL__STAFF,
				 true,
				 false,
				 true,
				 null,
