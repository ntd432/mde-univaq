...
/**
 * This is the item provider adapter for a {@link Healthcare.Department} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class DepartmentItemProvider extends NamedElementItemProvider {
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(HealthcarePackage.Literals.DEPARTMENT__STAFF);
		}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(Department.class)) {
			case HealthcarePackage.DEPARTMENT__STAFF:
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(HealthcarePackage.Literals.DEPARTMENT__STAFF,
				 HealthcareFactory.eINSTANCE.createEmployeeRole()));
	}
