 ...
 * @generated
 */
public class HealthcareSwitch<T> extends Switch<T> {
	/**
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case HealthcarePackage.NAMED_ELEMENT: {
			...
			case HealthcarePackage.CONDITION: {
			...
			case HealthcarePackage.EDUCATIONAL_INSTITUTE: {
				EducationalInstitute educationalInstitute = (EducationalInstitute)theEObject;
				T result = caseEducationalInstitute(educationalInstitute);
				if (result == null) result = caseOrganization(educationalInstitute);
				if (result == null) result = caseNamedElement(educationalInstitute);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case HealthcarePackage.DEPARTMENT: {
			...
			case HealthcarePackage.PATIENT: {
				Patient patient = (Patient)theEObject;
				T result = casePatient(patient);
				if (result == null) result = casePerson(patient);
				if (result == null) result = caseNamedElement(patient);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case HealthcarePackage.OBSERVATION: {
			...
			case HealthcarePackage.EMPLOYEE: {
			...
			case HealthcarePackage.QUALIFICATION: {
				Qualification qualification = (Qualification)theEObject;
				T result = caseQualification(qualification);
				if (result == null) result = caseNamedElement(qualification);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case HealthcarePackage.EMPLOYEE_ROLE: {
				EmployeeRole employeeRole = (EmployeeRole)theEObject;
				T result = caseEmployeeRole(employeeRole);
				if (result == null) result = caseNamedElement(employeeRole);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case HealthcarePackage.APPOINTMENT: {
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>Educational Institute</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>Educational Institute</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T caseEducationalInstitute(EducationalInstitute object) {
		return null;
	}
